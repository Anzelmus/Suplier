       ...
       <header class="absolute inset-x-0 top-0 z-50">
         <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
           ...
           <div class="hidden lg:flex lg:gap-x-12">
             ...
             <a href="{{ route('barang_masuk.index') }}" class="text-sm/6 font-semibold text-gray-900">Barangs  masuk</a>
             <a href="{{ route('barang_keluar.index') }}" class="text-sm/6 font-semibold text-gray-900">Barangs  keluar</a>
             <a href="{{ route('pinjam_barang.index') }}" class="text-sm/6 font-semibold text-gray-900">pinjams barang</a>
           </div>
