   ...
   <form action="{{ route('user.store') }}" method="POST">
     ...
     <div class="border-b border-gray-900/10 pb-12">
       ...
       <div class="mt-10 col-span-full gap-y-8">
         ...
         <div class="mt-2">
           <input id="id_user" name="id_user" type="text" autocomplete="id_user" value="{{ old('id_user') }}" required class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
         </div>
       </div>
     ...
     <div class="mt-6 flex items-center justify-end gap-x-6">
       ...
       <button type="submit" class="rounded-md 3bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save</button>
     </div>
   </form>
 </div>
</div>
